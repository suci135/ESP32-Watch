...
const char *AP_SSID = "service for the elderly"; // 设置AP热点名称
...
String wifi_ssid = "HONOR 60"; // 暂时存储wifi账号密码
String wifi_pass = "Hi20041021"; // 暂时存储wifi账号密码

const int LED =3; // 设置LED引脚
const int resetPin = 0;//重启
