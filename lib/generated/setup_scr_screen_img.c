...
void setup_scr_screen_img(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_img, 240, 280);
    ...
    lv_img_set_src(ui->screen_img_img_1, &_wifi_x_alpha_20x20);
    lv_img_set_pivot(ui->screen_img_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_img_1, 0);
    lv_obj_set_pos(ui->screen_img_img_1, 183, 0);
    lv_obj_set_size(ui->screen_img_img_1, 20, 20);
